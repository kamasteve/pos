                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Add Ledger Accounts</span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">Add Ledgers </a></li>
														<li><a href="#"> Income Accs</a></li>
                                                       <li><a href="#"> Expense Accs</a></li>
													   <li><a href="#">Current Assets Accs</a></li>
													   <li><a href="#">Capital Accs</a></li>
													   <li><a href="#"> Liability Accs</a></li>
													    <li><a href="#">Cash & Bank Acc </a></li>
														    <li><a href="#">Statutory Ded Accs </a></li>
                                                    </ul>
                                              ...
                                              <div class="simpleTabsContent">
                                                   ...
                                                   ViewExpense($_SESSION['company']);
                                                        ?>
                                                    </div>
													  <div class="simpleTabsContent">
                                                        <?php
                                                      
                                                   ViewCurrent($_SESSION['company']);
                                                        ?>
                                                    </div>
													 <div class="simpleTabsContent">
                                                        <?php
                                                      
                                                   ViewCapital($_SESSION['company']);
                                                        ?>
                                                    </div>
													 <div class="simpleTabsContent">
                                                        <?php
                                                      
                                                   ViewLiability($_SESSION['company']);
                                                        ?>
                                                    </div>
														 <div class="simpleTabsContent">
                                                        <?php
                                                      
                                                   ViewMonetary($_SESSION['company']);
                                                        ?>
                                                    </div>
														 <div class="simpleTabsContent">
                                                        <?php
                                                      
                                                   ViewStatutory($_SESSION['company']);
                                                        ?>
                                                    </div>
