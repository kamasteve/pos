...
$vat=$_POST['VAT'];
$session=session_id();
$R=mysql_query("select * from stocking where product_id='$id' and qty='$QTY' and t_code='$CODE'");
...
$t=mysql_query("insert into ledgers(credit,invoice,froms,session,account_id,mat_date,description,date,quantity,product)values
('$TOTALL','$CODE','$froms','$session','$supplier','$expected','PURCHASES','$date','$QTY','$pname')");
