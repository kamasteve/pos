...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.0.0.58475 -->
        <meta charset="utf-8">
        <title>Payroll Adjustement</title>
                    ...
                    <div class="art-content-layout">
                        <div class="art-content-layout-row">
                            <div class="art-layout-cell art-sidebar1 clearfix"><div class="art-vmenublock clearfix">
								   ...
								   <?
											 $_SESSION['er']=$_GET['idd'];
											 ?>
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Payroll Adjustement For <?echo Employees($_SESSION['er']);?></span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
														...
														<li><a href="#">Adjust Bonuses</a></li>
                                                  <li><a href="#">Adjust Deductions</a></li>
                                                    </ul>
...
$employee=$_SESSION['er'];
$date=$_REQUEST['date'];
$amount=$_REQUEST['amount'];
$account=$_REQUEST['id'];
 AdjustBonuses($account,$employee,$amount,$date);
}
                                                    Additions($_SESSION['er']);
                                                        ?>
                                                    </div>
                                                  <div class="simpleTabsContent">
                                                        <?php
                                                      if (isset($_REQUEST['ded'])) {

$employee=$_SESSION['er'];
$date=$_REQUEST['date'];
$amount=$_REQUEST['amount'];
$account=$_REQUEST['id'];
  AdjustDeductions($account,$employee,$amount,$date);
}
                                                 Deductions($_SESSION['er']);
                                                        ?>
                                                    </div>
