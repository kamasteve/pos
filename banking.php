...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.0.0.58475 -->
        <meta charset="utf-8">
        <title>Banking & Reconciliation</title>
    ...
    <body>
        <div id="art-main">
            ...
            <div class="art-sheet clearfix">
                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Banking & Reconciliation For <? echo Mode($_SESSION['bank']);?></span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">Input Bank Statement </a></li>
														<li><a href="#">View Bank Statement</a></li>
														<li><a href="#">View Cash Book</a></li>
                                                       
													         <li><a href="#">View Reconciled Statement</a></li>
                                                    </ul>
				...
				InputBank($_REQUEST['date'],$_REQUEST['credit'],$_REQUEST['debit'],$_REQUEST['no'],$_SESSION['session'],$_SESSION['bank']);
                                                        }
														   if (isset($_REQUEST['reconcile'])) {
                                                        
				CreateReconciliation($_SESSION['bank']);
                                                        }
                                                      Reconciliation();
                                                        ?>
                                                    </div>
                                                  ...
                                                  ViewBankR($_SESSION['session']);
                                                        ?>
                                                    </div>
													      <div class="simpleTabsContent">
                                                        <?php
                                                      
                                                    ActiveBank($_SESSION['bank']);
                                                        ?>
                                                    </div>
                                              <div class="simpleTabsContent">
                                                        <?php
                                                   ...
                                                   ReconceReport($_SESSION['bank'],date("Y/m/d"));
                                                        ?>
                                                    </div>
