...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.0.0.58475 -->
        <meta charset="utf-8">
        <title>Product Margins Per Category</title>
                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Products Qty Sold Per Category</span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">Products Qty Sold Per Category</a></li>
                                                    ...
                                                    <div class="simpleTabsContent">
													   ...
													   $date1=$_REQUEST['date1'];
														...
														$name=$_REQUEST['id'];
														$url="best_cc.php?=date1=$date1&date2=$date2&id=$name";
                                                       ob_end_clean();
header("Location: $url");
                                                        }
                                                 DSForm($_REQUEST['id']) ;
