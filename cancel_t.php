...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.0.0.58475 -->
        <meta charset="utf-8">
        <title>Cancel Ledger Transactions</title>
                        ...
                        <div class="art-content-layout-row">
                                        ...
                                        <ul class="art-vmenu">
											  ...
											  <li>
                                                ...
                                                <li>
													 ...
													 <li>
                                                        <a href="record_exp.php">Cancel Ledger Transactions</a>
                                                    </li>
													 <li>
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Cancel Ledger Transactions</span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">Cancel Ledger Transactions</a></li>
                                                    ...
                                                    <div class="simpleTabsContent">
                                                        ...
                                                        if (isset($_REQUEST['get'])) {
														 ...
														 $amount=$_REQUEST['amount'];
														 											$url="delete_allt.php?date=$date&amount=$amount";
                                                       ob_end_clean();
header("Location: $url");
                                                        }
														else{
