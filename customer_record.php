...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.0.0.58475 -->
        <meta charset="utf-8">
        <title>Record Customer Invoices</title>
                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Record Customer Invoices</span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">Record Customer Invoices</a></li>
                                                    ...
                                                    <div class="simpleTabsContent">
														...
														$status=DateStatus($date);
														 if($status!='CLOSED'){
														 IncomeRecorddC($income,$customer,$date,$amount,$invoice);
														   $name=Legers($customer);
														  $namee=Legers($income);
														UserAudit($_SESSION['user'],"Recorded $amount $namee Invoice for $name Customer ",date("Y/m/d"),$ip);
														 //IncomeRecordd($income,$customer,$date,$amount,$invoice,$project);
														 } else{
