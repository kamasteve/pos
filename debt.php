                        ...
                        <div class="art-content-layout-row">
                                    ...
                                    <div class="art-vmenublockcontent">
                                           <ul class="art-vmenu">
                                            <li>
                                                ...
                                                <ul class="active">
                                                    <li>
                                                        <a href="create_r.php">Create Requisition</a>
                                                    </li>
											  ...
											  <li>
                                                <a href="" class="active">Lpo</a>
                                                <ul class="active">
                                                    <li>
                                                        <a href="get_code.php">Create Lpo</a>
                                                    </li>
                                                   
                                                    <li>
                                                        <a href="view_lpo.php">View Lpo</a>
                                                    </li>
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Debt Swap</span></h2>
