...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.0.0.58475 -->
        <meta charset="utf-8">
        <title>Record Customer Payment</title>
                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Record Customer Payment</span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">Record Customer Payment</a></li>
											 ...
											 if($date!=''){
														...
														UserAudit($_SESSION['user'],"Recorded $payment for customer $namee ",date("Y/m/d"),$ip);
                                        
												IncomePayments($customer,$payment,$date,$amount);
												} else{
