                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Customer Deposits</span></h2>
										  ...
										  $id=$_REQUEST['id'];
										   $date=$_REQUEST['date'];
										    $amount=$_REQUEST['amount'];
                                              $to=$_REQUEST['to'];
											  AddDeposit($name,$amount,$date,$id,$phone,$to);
												UserAudit($_SESSION['user_id'],"Added Customer Deposit For $name",date("Y/m/d"),$ip);}
												 Deposits() ;
                                                        ?>
