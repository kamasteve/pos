...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.0.0.58475 -->
        <meta charset="utf-8">
        <title>Multi Doulbe Entry</title>
    ...
    <ul class="art-vmenu">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Multiple Double Entry (Please Choose A Debit Or A Credit *Not Both*)</span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">Multiple Double Entry **Please choose either a debit or credit to start**</a></li>
                                                    ...
                                                    <div class="simpleTabsContent">
                                                        <?php
														if($_GET['msg']){
                                                      echo '<span class="red"> Transaction Not Possible '.$_GET['msg'].'</span></br>';
													  }
                                                     AccountDC();
                                                        ?>
                                                    </div>
