    ...
    <ul class="art-vmenu">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Multiple Double Entry</span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">Multiple Double Entry **Please press finish only if you have finished all the transactions**</a></li>
                                                    ...
                                                    <div class="simpleTabsContent">
                                                        ...
                                                        if (isset($_REQUEST['add'])) {
														  ...
														  $balance=$_REQUEST['balance']-$_REQUEST['amount'];
														 ...
														 $msg='Please Choose A Valid Date';
														  ...
														  if($balance<0){
														 $msg='Transaction Not Complete !!! Enter An Amount Less Or Equal To Balance';
														 }
														 $status=DateStatus($date);
														 if($status!='CLOSED'){
													if($date!=''&&$balance>=0){	
													$_SESSION['amount']=$_SESSION['amount']-$amount;
														DoubleEntryM($credit,$debit,$amount,$date,$desc,$sub,$_SESSION['multiple']);}
														}else{
														$msg='Transaction Not Possible ! Financial Year Already Closed !!';
														}
                                                     ...
                                                     unset($_SESSION['date']);
													  unset($_SESSION['cheque']);
                                                       ...
                                                       echo '<span class="green">Transactions  Completed Succesfully !</span></br>';
														}
											
														if( ($_SESSION['gg'])&&($_SESSION['multiple']) && ($_SESSION['date'])&& ($_SESSION['amount'])){
                                                      DoubleEE($_SESSION['debit'],$_SESSION['credit'],$_SESSION['date'],$_SESSION['cheque'],$_SESSION['amount']);
													  }
                                                        ?>
                                                    </div>
