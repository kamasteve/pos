    ...
    <ul class="art-vmenu">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Double Entry</span></h2>
                                                ...
                                                <div class="simpleTabs">
													...
													$status=DateStatus($date);
														 if($status!='CLOSED'){
														  $namee=Legers($debit);
														  $name=Legers($credit);
														UserAudit($_SESSION['user'],"Recorded  doulble entry amount $amount,debited $namee credited  $name
														 ",date("Y/m/d"),$ip);
														DoubleEntry($credit,$debit,$amount,$date,$desc,$sub);}
														else{
