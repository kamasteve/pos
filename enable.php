...
$t="update users set status='ACTIVE' where user_id='$id'";
...
$row=mysql_fetch_array($r);
 echo '<form action="enable.php"method="post">
 <h3>Account Name: ' . $row['name'] . '</h3>
 <p><b>Are you sure you want to Enable  This User Account ?<br />
 <input type="radio" name="sure"
value="Yes" /> Yes
 <input type="radio" name="sure" value=
"No" checked="checked" /> No</p>
 <p><input type="submit" name="submit"
value="Enable Account" /></p>
