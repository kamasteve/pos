...
$r="SELECT * FROM expenses order by exp_id  ASC";
...
?>
 ...
 <p align="center"><a rel="facebox" href="add_products.php">Add New Sale Products Not Present In Database</a> </p>
...
{ 
      ...
      echo '<td><div align="center">'.$row['exp_id'].'</div></td>';
      echo '<td><div align="center">'.$row['amount'].'</div></td>';
	   ...
	   echo '<td><div align="center">'.$row['added_by'].'</div></td>';
          ...
          <div id="tablenav">
			...
			<div id="tablelocation">
            	<div>
                    ...
                    <option value="50" selected="selected">10</option>
