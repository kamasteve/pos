                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Financial Year Administration</span></h2>
   <h3 class="art-postheader"><?echo $_SESSION['msg'];?></h3>
                                    <!------form start----->
                                    ...
                                    <div class="art-content-layout">
                                        <div class="art-content-layout-row">
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">Add New Financial Year</a></li>
														<li><a href="#">Administer Financial Years</a></li>
										 ...
										 UserAudit($_SESSION['user_id'],"Created New Financial Year $date1 To $date2",date("Y/m/d"),$ip);
                                            AddYear($date1,$date2);}
												financial();
                                                        ?>
