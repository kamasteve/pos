                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Funds Transfer</span></h2>
                                                ...
                                                <div class="simpleTabs">
                                                    ...
                                                    <div class="simpleTabsContent">
                                                        ...
                                                        if (isset($_REQUEST['add'])) {
														 ...
														 $name=Legers($form);
														  $namee=Legers($to);
														 	UserAudit($_SESSION['user'],"Transferred    $amount  from $name to $namee ",date("Y/m/d"),$ip);
														TransferFunds($form,$to,$date,$cheque,$amount,$desc);
                                                        }
														 else{
