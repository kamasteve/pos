                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Get Products With Changed Buying Prices Over Dates</span></h2>
                                                ...
                                                <div class="simpleTabs">
                                                    ...
                                                    <div class="simpleTabsContent">
													   ...
													   $date1=$_REQUEST['date1'];
														...
														$url="changedd.php?date1=$date1&date2=$date2";
                                                       ob_end_clean();
header("Location: $url");
                                                        }
                                                   DDForm()  ;
