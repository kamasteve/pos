...
<html dir="ltr" lang="en-US"><head><!-- Created by Artisteer v4.0.0.58475 -->
        <meta charset="utf-8">
        <title>One Cheque Multiple Expenses</title>
                        ...
                        <div class="art-content-layout-row">
                                        ...
                                        <ul class="art-vmenu">
											  ...
											  <li>
                                                ...
                                                <li>
													 ...
													 <li>
                                                        <a href="record_exp.php">One Cheque Multiple Expenses</a>
                                                    </li>
													 <li>
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">One Cheque Multiple Expenses</span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">One Cheque Multiple Expenses</a></li>
                                                    ...
                                                    <div class="simpleTabsContent">
                                                        ...
                                                        if (isset($_REQUEST['add'])) {
														   ...
														   $date=$_REQUEST['date'];
														  $bank= $_REQUEST['bank'];
														$url="special_cheque.php?date=$date&bank=$bank&cheque=$cheque";
														ob_end_clean();
header("Location: $url");
