                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Payroll Vote Heads</span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
													 <li><a href="#">Add Payroll Vote Heads As Sub Ledgers</a></li>
                                                        <li><a href="#">Add Payroll Vote Heads As Ledgers</a></li>
														<li><a href="#">View Allowance Vote Heads</a></li>
                                                       <li><a href="#">View Deductions Vote Heads</a></li>
                                                    </ul>
													     <div class="simpleTabsContent">
                                                        <?php
                                                        if (isset($_REQUEST['ledgers'])) {
                                                            $name=$_REQUEST['name'];
														$id=$_REQUEST['id'];
														$status=$_REQUEST['idd'];
														$type=$_REQUEST['type'];
														
														AddSubP($name,$id,$status,$type);
                                                        }
