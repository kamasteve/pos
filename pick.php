...
require_once('functions.php');
	...
	$ip=get_client_ip() ;
		 $till=teller($ip);
	CXreport($user,$till,$cash,$credit,$mpesa,$cheque,$x,$float,$picked,$petty);
...
</style><form action="pick.php" method="post"><div align="center"><fieldset class="fieldset-auto-width"><legend>Create Z Report</legend>
Opening Float:<br />
