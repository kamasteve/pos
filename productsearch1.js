...
function bleble() {
	if (searchReq.readyState == 4 || searchReq.readyState == 0) {
		...
		searchReq.open("GET", 'searchSuggest23.php?searchs=' + str, true);
...
function handleSearchSuggest() {
	if (searchReq.readyState == 4) {
		...
		if(str.length==1)
		    ...
		    ss.setAttribute('style','position:absolute;top:'+curTop+';left:'+curLeft+';width:300;z-index:1;padding:5px;border: 1px solid #000000; overflow:auto; height:205; background-color:#F5F5FF;');
		ss.innerHTML = '';
