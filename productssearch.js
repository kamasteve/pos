...
function bleble() {
	if (searchReq.readyState == 4 || searchReq.readyState == 0) {
		var str = escape(document.getElementById('amotss').value);
		searchReq.open("GET", 'searchSuggest.php?searchs=' + str, true);
...
function handleSearchSuggest() {
	if (searchReq.readyState == 4) {
		...
		var str1 = document.getElementById('amotss');
		var curLeft=0;
		...
		var str2 = document.getElementById('amotss');
		var curTop=20;
...
function setSearch(value) {
	document.getElementById('amotss').value = value;
