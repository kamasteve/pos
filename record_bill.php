                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Record Bills</span></h2>
                                                ...
                                                <div class="simpleTabs">
                                                    ...
                                                    <div class="simpleTabsContent">
														...
														$status=DateStatus($date);
														 if($status!='CLOSED'){
														  $name=Legers($supplier);
														  $namee=Legers($bill);
														UserAudit($_SESSION['user'],"Recorded $amount $namee Bill from $name supplier ",date("Y/m/d"),$ip);
														 billRecord($bill,$supplier,$date,$amount,$invoice,$maturity,$vat);
														} else{
