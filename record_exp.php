                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Record Expenses</span></h2>
                                                ...
                                                <div class="simpleTabs">
                                                    ...
                                                    <div class="simpleTabsContent">
														...
														$status=DateStatus($date);
														 if($status!='CLOSED'){
														  $name=Legers($credit);
														UserAudit($_SESSION['user'],"Recorded $amount $name expenses ",date("Y/m/d"),$ip);
														RecordLedgerExp($credit,$payment,$date,$cheque,$amount,$desc,$department,$sub,$receipt,$vat);
                                                        }
														else{
