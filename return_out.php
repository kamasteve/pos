...
<script language="JavaScript" type="text/javascript" src="rejectss.js"></script>
...
<form action="add_retruns.php" method="post" name="abc"><div class="wraper">
<fieldset style="border-width: 5px;">
  ...
  <tr>
    ...
    <td colspan="3">
	<input  style="background-color:#e8e8e8;" name="PNAME" type="text" value="<?php echo $desc ?>" size="50" style="border:0px;" readonly/></td>
	
 <td width="104"><div align="left">Invoice No : </div></td>
    <td width="184">
  ...
  <tr>
   ...
   <td width="104"><div align="left">Debit No : </div></td>
    <td width="184">
      <input name="CREDIT" style="background-color:#e8e8e8;font-size:16px" value="<?php echo $_SESSION['OUT']; ?>" readonly/>
   </td>
  ...
  <fieldset style="border-width: 3px;">
					...
					<legend style="font-family:Bell Gothic,Verdana,Arial"><b>Debit Note List</legend>
  <div class="center">
...
mysql_select_db("point_of_sale", $con);
 $f=$_SESSION['OUT'];
$result = mysql_query("SELECT * FROM return_out
...
?>
	  ...
	  <form action="debit_notes.php" method="post">
	  <table id="header" width="550" border="0" cellpadding="0" cellspacing="0"><tr>
	  <td colspan="3"><input style="height: 44px; width: 210px; cursor:pointer;" name="submit" type="submit" value="PRINT DEBIT NOTE"></tr>
