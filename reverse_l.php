...
Permission($_SESSION['department'],$type);
				...
				headermenu($_SESSION['department'],'ACCOUNTS'); ?> 
            </nav>
                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon"> Reverse Customer Invoice</span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">Reverse Customer Invoice</a></li>
...
if($id){
if($status=='Yes'){
UserAudit($_SESSION['user_id'],"Reversed Sales Invoice $id",date("Y/m/d"),$ip);
ReverseReceipts($id);
}}}
if(isset($_REQUEST['ded'])){
 ...
 echo '<form action="reverse_l.php" method="post">
 <h3>Receipt : ' . $id . '</h3>
