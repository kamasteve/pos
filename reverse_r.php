                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon"> Reverse Receipt</span></h2>
                                            ...
                                            <div class="art-layout-cell" style="width: 100%" >
                                                <div class="simpleTabs">
                                                    <ul class="simpleTabsNavigation">
                                                        <li><a href="#">Reverse Receipt</a></li>
...
if($id){
if($status=='Yes'){
UserAudit($_SESSION['user_id'],"Reversed Receipt $id",date("Y/m/d"),$ip);
ReverseReceipt($id);
}}}
if($_REQUEST['id']){
 $id = $_GET['id'];
 ...
 echo '<form action="reverse_r.php"method="post">
 <h3>Receipt : ' . $id . '</h3>
