                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content clearfix">
                                <article class="art-post art-article">
                                    <h2 class="art-postheader"><span class="art-postheadericon">Supplier Payments</span></h2>
...
<input type="text" name="na" required="required"/></div>
<div class="two">
<label>Amount</label>
<input type="number" name="amont" required="required"/></div>
...
<div class="two"><button type="submit" name="submit">SUBMIT</button>
			...
			if(isset($_POST['submitted'])){
				$sup=mysqli_real_escape_string($dbc,trim($_POST['na']));
				$am=mysqli_real_escape_string($dbc,trim($_POST['amont']));
				$da=mysqli_real_escape_string($dbc,trim($_POST['date']));
				$q=mysqli_query($dbc,("insert into exp_sup(amount,name,date)values('$am','$sup','$da')"));
				if($q){
