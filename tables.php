...
shortcut.add("Space",function setFocusToBox(){
document.getElementById("b").focus();
});
shortcut.add("Home",function setFocusToBox(){
...
<div id="layer2" style="margin-right:-30px;"></div>
 ...
 cellpadding="0"><tr><td>
	  ...
	  <input type="submit"  style="height:0px;width:0px;border:none;padding:0px;" hidefocus="true"/></form></td><td>
 			 ...
 			 <input type="text"  autofocus="autofocus" id="amots" placeholder=" Put Product Name Here..... "
			  size="30" onKeyUp="bleble();" autocomplete="off"/>
          
             <ul id="result"></ul></td></tr></table>
...
<table align="center" frame="BOX"  style="border-color:#000000;font-size:18px ;background-color:;" frame="BOX" border="0.2"  width="980px" 
 ...
 <th
 style="border-color:#000000;background-color:#bbbbbb;">Update</th></tr>
 <tr>
